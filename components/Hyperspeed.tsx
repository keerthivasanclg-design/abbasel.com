...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
    // Stringify to create a stable dependency for useMemo, preventing re-renders.
    const stringifiedEffectOptions = JSON.stringify(effectOptions);

    const mergedOptions: HyperspeedOptions = useMemo(() => ({
      ...defaultOptions,
      ...effectOptions
    // eslint-disable-next-line react-hooks/exhaustive-deps
    }), [stringifiedEffectOptions]);
